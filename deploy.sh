...
# main config
PLUGINSLUG="woocommerce-stellar"
CURRENTDIR=`pwd`
MAINFILE="woocommerce-stellar-gateway.php" # this should be the name of your main php file in the wordpress plugin
...
SVNURL="http://plugins.svn.wordpress.org/woocommerce-stellar/" # Remote SVN repo on wordpress.org, with no trailing slash
